...
class KittiOdometryDataset(Dataset):
    ...
    def __init__(self, dataset_dir, frame_count=2, sequences=None, depth_folder="image_depth_annotated",
                 target_image_size=(256, 512), max_length=None, dilation=1, offset_d=0, use_color=True, use_dso_poses=False, use_color_augmentation=False, lidar_depth=False, dso_depth=True, annotated_lidar=True, return_stereo=False, return_mvobj_mask=False, use_index_mask=()):
        """
        ...
        :param return_mvobj_mask: Return additional moving object mask.
        """
...
torchvision_version = torchvision.__version__.split(".")[1]

if int(torchvision_version) < 9:
