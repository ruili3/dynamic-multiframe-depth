...
class Evaluater(BaseTrainer):
    ...
    def eval(self, model_index):
        ...
        log = {
            ...
            'metrics': self.save_digits((total_metrics / total_metrics_valid).tolist()),
            'metrics_mv': self.save_digits((total_metrics_mv / total_metrics_valid_mv).tolist()),
            'metrics_correct': self.save_digits(total_metrics_runningavg.tolist()),
            'valid_batches': total_metrics_valid[0],
            'valid_batches_mv': total_metrics_valid_mv[0]
        }
